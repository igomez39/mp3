...
pal1 <- colorFactor(
  palette = c("darkorange","blue", "red", "white", ""),
...
qpal <- colorQuantile("Blues", challenges$average_slope, n=4)

                    
leaflet () %>%
  addTiles%>%
   addPolylines(data = challenges,weight = 2, color = ~pal2(average_slope))%>%
